...
def atualiza_historico_troca(form,carro):
    ...
    if(form.cleaned_data['trocar_pastilhaFreio']):
        ...
        historico = HistoricoTroca(carro=carro,dePeca=pastilha_velha,paraPeca=pastilha_nova,tipoPeca='PF',saudePeca=carro.kmPastilha,diaDaTroca=datetime.today().date(),quilometragem=carro.quilometragem)
        historico.save()
